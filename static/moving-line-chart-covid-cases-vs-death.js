...
function line(type1, type2, tickDuration, yearStart, yearStop){
    ...
    svg.append("text")
        ...
        .style("fill","black")
        .call(text => text.append("tspan").attr("font-size","21px").attr("fill","#021B79").attr("font-weight", "bold").text("\xa0"+type1+"\xa0"))
        .call(text => text.append("tspan").attr("font-size","21px").attr("font-weight", "bold").text("\xa0 vs \xa0"))
        .call(text => text.append("tspan").attr("font-size","21px").attr("fill","#c21500").attr("font-weight", "bold").text("\xa0"+type2+"\xa0"))
    ...
    d3.json("/static/teste6.json").then(function(data){
        
     
       var case_types = [{'id':String(type1),"title":String(type1),"color":["blue"]},
                        {'id':String(type2),"title":String(type2),"color":["red"]}]     
